...
{
    wp_enqueue_script('tc-styles-10', TUDOCLASSIFICADOS_URL_ASSETS . 'jquery/jquery-3.6.0.min.js');
    ...
    wp_enqueue_script('tc-script-8', TUDOCLASSIFICADOS_URL_ASSETS . 'carroucel/principal.js', [], false, true);
}
