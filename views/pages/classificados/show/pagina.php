<div class="container">
    <div class="row rounded m-md-0 mb-5 pt-3">
        <div class="col-md-8 order-md-1 order-2">
            <!--IMAGEM PRINCIPAL -->
            <?php require_once TUDOCLASSIFICADOS_PATH_VIEW . 'components/anuncio-unico/imagem-principal.php' ?>
            ...
            <!-- Comentarios -->
            <?php include TUDOCLASSIFICADOS_PATH_VIEW . 'components/anuncio-unico/comentarios.php' ?>
        </div>
    ...
    <div class="row m-3">
        <div class="col-12">
            <!-- Horizontal-1 -->
            <ins class="adsbygoogle" style="display:none" data-ad-client="ca-pub-5788964970631749"
