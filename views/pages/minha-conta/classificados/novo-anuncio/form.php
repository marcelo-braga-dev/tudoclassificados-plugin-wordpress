        ...
        <div class="card">
            <div class="card-header bg-white">
                <div class="row justify-content-between align-items-center px-3">
                    <div>
                        <h3 class="mb-0">Cadastrar novo anúncio</h3>
                    </div>
                    <div>
...
<!--                            </div>-->
                            <form action="<?= esc_url(acadp_get_listing_form_page_link()); ?>" method="post">
                                ...
                                <?php else : ?>
                                    <input type="number" class="acadp-category-listing d-none" name="acadp_category"
                                           id="categoria-anuncio" value="<?= $category ?>" required>
                                <?php endif ?>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-6 col-md-2">
                                                ...
                                                <div class="input-group">
                                                    <input type="number" class="form-control dimensionamento"
                                                           name="altura"
                                                           value="<?= isset($post_meta['altura']) ? $post_meta['altura'][0] : '' ?>"
                                                           required>
                                            ...
                                            <div class="col-6 col-md-2">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control dimensionamento"
                                                           name="largura"
                                                           value="<?= isset($post_meta['largura']) ? $post_meta['largura'][0] : '' ?>"
                                                           required>
                                                    <div class="input-group-append">
                                                        <div class="input-group-text">cm</div>
                                                    </div>
                                            ...
                                            <div class="col-6 col-md-2">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control dimensionamento"
                                                           name="comprimento"
                                                           value="<?= isset($post_meta['comprimento']) ? $post_meta['comprimento'][0] : '' ?>"
                                                           required>
                                                    <div class="input-group-append">
                                                        <div class="input-group-text">cm</div>
                                                    </div>
                                            ...
                                            <div class="col-6 col-md-2">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control dimensionamento" name="peso"
                                                           value="<?= isset($post_meta['peso']) ? $post_meta['peso'][0] : '' ?>"
                                                           required>
                                                    <div class="input-group-append">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group form-check">
                                                    <input type="checkbox" class="form-check-input" id="frete-gratis"
                                                           name="frete-gratis" value="S"
                                                           style="font-size: 16px !important;">
                                                    <label class="form-check-label"
                                                           style="font-size: 16px !important; color: black !important"
                                                           for="frete-gratis">Oferecer frete grátis</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card mb-3">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group bmd-form-group">
                                                    <label class="control-label" for="acadp-website"><small>Link do Site
                                                            de Venda</small></label>
