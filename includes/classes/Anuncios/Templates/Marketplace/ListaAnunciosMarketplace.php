...
class ListaAnunciosMarketplace
{
    public function __construct()
    {
        add_shortcode("tc_lista_anuncios_marketplace", array($this, "run_shortcode_lista_anuncios_marketplace"));
    }

    public function run_shortcode_lista_anuncios_marketplace($atts)
    {
        $term_slug = 'marketplace';
