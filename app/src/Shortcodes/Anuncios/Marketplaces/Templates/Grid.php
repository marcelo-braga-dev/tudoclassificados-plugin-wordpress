...
class Grid
{
    ...
    {
        add_shortcode("tc_grid_classificados", array($this, "run_shortcode_grid_classificados"));
    }

    public function run_shortcode_grid_classificados($atts)
    {
