...
namespace TudoClassificados\App\Views\Pages\Imoveis\Anuncios;
...
class Index
{
    ...
    {
        add_shortcode("tc_lista_anuncios_imoveis", array($this, "run_shortcode_lista_anuncios_imoveis"));
    }

    public function run_shortcode_lista_anuncios_imoveis($atts)
    {
        $cidade = $_GET['cidade'];
        $term_slug = 'imoveis';
