...
namespace TudoClassificados\App\Services\Shortcodes\Anuncios\Gerenciar;
...
class Classificados
{
    public function executar()
    {
        ...
        $shortcode = 'acadp_manage_listings_classificados';
        ...
        // Process output
        ob_start();
        include TUDOCLASSIFICADOS_PATH . 'views/components/minha-conta/classificados/edit-anuncio.php';
